...
function plugin:EntityTakeDamage(target, info)
	if ( IsValid(target) and target:IsPlayer() ) then
		...
		local items = target:GetCharacter():GetInventory():GetItemsByBase("base_armor")

		for k, v in pairs(items) do
			if (v:GetData("equip", true)) then return end
		end
