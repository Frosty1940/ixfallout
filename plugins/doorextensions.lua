...
ix.lang.AddTable("korean", {
	cmdDoorsSetUnownable = "모든 문을 소유할 수 없도록 설정합니다.",
	cmdDoorsSetOwnable = "모든 문을 소유할 수 있도록 설정합니다.",
	cmdDoorsSetDisabled = "모든 문에 명령어를 사용할 수 없도록 설정합니다.",
	cmdDoorsSetHidden = "모든 문의 설명을 숨기지만, 소유할 수 있도록 설정합니다.",
})
