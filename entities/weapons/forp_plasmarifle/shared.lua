...
SWEP.Instructions				= L("itemPlasmaRifleDesc") --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= L("Plasma rifle")		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("plasmapistolshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 280 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi = 280 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.Ammo = "MicrofusionCell" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_plasmarifle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_plasmarifle.mdl" -- Weapon world model path
...
--Vector(8.446, 1.085, -3.256), angle = Angle(-11.813, 0, 174.91) rif
--Vector(4.796, 0.964, -0.82), angle = Angle(-5.844, 0, 180) ref
...
SWEP.IronSightsPos = Vector(-6.481, 0, 1.399)
SWEP.IronSightsAng = Vector(-0.108, -2.277, -0.283)
...
SWEP.MuzzleFlashEffect = "fo3_muzzle_plasmarifle" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
