...
SWEP.Instructions				= L("itemR91AssaultRifleDesc") --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= L("Assault rifle")		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("r91shoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 440 -- This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_r91.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_r91.mdl" -- Weapon world model path
...
-- Vector(5.73, 0.428, -1.277), angle = Angle(-11.002, -0.196, 180)
...
SWEP.IronSightsPos = Vector(-4.481, -5.961, 1.36)
SWEP.IronSightsAng = Vector(0.2, -2.3, 0)
...
--[[ATTACHMENTS]]--
-- SWEP.WElements = {
-- 	["element_name"] = { type = "Model", model = "models/illusion/fwp/w_r91.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(-0.167, -1.79, 5.783), angle = Angle(1.884, -3.366, -101.462), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
-- }
SWEP.WElements = {
