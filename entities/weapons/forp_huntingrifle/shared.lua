if (CLIENT) then
	SWEP.PrintName = L("Hunting rifle") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("itemHuntingRifleDesc") --Instructions Tooltip
end
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("hrshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_huntingrifle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_huntingrifle.mdl" -- Weapon world model path
...
--Vector(6.882, 0.777, -1.196), angle = Angle(-14.256, 1.875, 180) hunting rifle
...
SWEP.IronSightsPos = Vector(-4.283, -11.16, 2.079)
SWEP.IronSightsAng = Vector(-1.371, -2.161, 0)
