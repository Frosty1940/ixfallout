if (CLIENT) then
	SWEP.PrintName = L("12.7mm pistol") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("item127mmPistolDesc") --Instructions Tooltip
end
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("127shoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Ammo = "127mm" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--Firing Cone Related
SWEP.Primary.Spread = .11 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .11 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_127pistol.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_127mmpistol.mdl" -- Weapon world model path
...
--Vector(6.605, 1.088, -0.373), angle = Angle(0, 1.824, 180) 127mm
...
SWEP.IronSightsPos = Vector(-4.72, 0, 0.4)
SWEP.IronSightsAng = Vector(-0.21, -2.401, 0)
