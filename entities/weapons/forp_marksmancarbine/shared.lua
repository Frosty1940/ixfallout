...
SWEP.Instructions				= L("itemMarksmanCarbineDesc") --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= L("Marksman carbine")		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("mcshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi = 420 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_marksmancarbine.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_marksmancarbine.mdl" -- Weapon world model path
...
--Vector(-10.304, 5.479, -4.834), angle = Angle(-7.288, 1.468, 180) ref

--Vector(7.888, 0.368, -1.438), angle = Angle(-7.288, 1.468, 180)
...
SWEP.Secondary.IronFOV = 56 -- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
SWEP.IronSightsPos = Vector(-3.879, -6.349, 0.332)
SWEP.IronSightsAng = Vector(0, 0, 0)
local scope = {}

SWEP.RTMaterialOverride = -13 --the number of the texture, which you subtract from GetAttachment
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "SVRifle", rel = "", pos = Vector(3.99, -2.577, -0.216), angle = Angle(0, -101.426, -90), size = Vector(0.252, 0.252, 0.252), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
