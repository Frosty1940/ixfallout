if (CLIENT) then
	SWEP.PrintName = L("Cowboy repeater") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("itemCowboyRepeaterDesc") --Instructions Tooltip
end
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("cowboyshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_cowboyrepeater.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_cowboyrepeater.mdl" -- Weapon world model path
...
--Vector(6.468, 0.782, -1.29), angle = Angle(-11.678, 2.657, 174.912)repeater
...
SWEP.IronSightsPos = Vector(-5.12, -5.684, 1.84)
SWEP.IronSightsAng = Vector(0, 2.289, 0)
