...
SWEP.Instructions				= L("itemLaserPistolDesc") --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= L("Laser Pistol")		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("laserpistolshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 340 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi = 340 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_laserpistol.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_laserpistol.mdl" -- Weapon world model path
...
--Vector(5.763, 2.025, -0.285), angle = Angle(-11.768, -7.042, -173.678) pistol
--Vector(4.796, 0.964, -0.82), angle = Angle(-5.844, 0, 180) ak12
...
SWEP.IronSightsPos = Vector(-4.921, 0, 1)
SWEP.IronSightsAng = Vector(-1.099, -2.381, 0)
...
SWEP.MuzzleFlashEffect = "fo3_muzzle_laserrifle" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
--Impact Effects
SWEP.ImpactEffect = "effect_fo3_laserhit"--Impact Effect
