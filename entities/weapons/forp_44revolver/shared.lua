if (CLIENT) then
	SWEP.PrintName = L(".44 Magnum revolver") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("item44RevolverDesc") --Instructions Tooltip
end
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("magnumshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_44magnum.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_44magnum.mdl" -- Weapon world model path
...
--Vector(7.116, 0.675, -0.931), angle = Angle(-10.613, -0.607, -180) on alyx
--Vector(4.796, 0.964, -0.82), angle = Angle(-5.844, 0, 180) ak12
--Vector(7.294, 0.676, -1.389), angle = Angle(-10.613, -0.607, -180) on barney
...
SWEP.IronSightsPos = Vector(-4.64, 0, 1.159)
SWEP.IronSightsAng = Vector(0.148, -2.1, 0)
...
SWEP.Blowback_Only_Iron = true --if u do this it removes the bolt action
