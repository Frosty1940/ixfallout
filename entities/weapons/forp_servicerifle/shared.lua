...
SWEP.Instructions				= L("itemServiceRifleDesc") --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= L("Service rifle")		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("svshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .055 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_servicerifle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_servicerifle.mdl" -- Weapon world model path
...
--Vector(8.284, 0.082, -1.711), angle = Angle(-8.056, 0, 180) serv
...
SWEP.IronSightsPos = Vector(-4.2, -4.56, 0.6)
SWEP.IronSightsAng = Vector(-1.201, -2.5, 0)
