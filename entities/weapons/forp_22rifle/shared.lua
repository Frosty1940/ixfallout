if (CLIENT) then
	SWEP.PrintName = L(".22 rifle") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("item22RifleDesc") --Instructions Tooltip
end
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("varmintshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi = 64 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.Ammo = "22LR" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_varmintrifle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_varmintrifle.mdl" -- Weapon world model path
...
--Vector(7.132, 1.116, -1.351), angle = Angle(-10.801, 2.197, 180) var
...
SWEP.IronSightsPos = Vector(-4.401, -9.804, 2.16)
SWEP.IronSightsAng = Vector(-1.178, -2.135, 0.707)
