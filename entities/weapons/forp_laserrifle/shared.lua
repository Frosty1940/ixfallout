if (CLIENT) then
	SWEP.PrintName = L("Laser rifle") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("itemLaserRifleDesc") --Instructions Tooltip
end
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("laserrifleshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_laserrifle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_laserrifle.mdl" -- Weapon world model path
...
--Vector(7.935, 0.345, -3.102), angle = Angle(-9.429, 1.294, 180) laserrifle
...
SWEP.IronSightsPos = Vector(-5.921, -4.56, 1.879)
