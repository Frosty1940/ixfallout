if (CLIENT) then
	SWEP.PrintName = L("10mm submachine gun") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("item10mmSMGDesc") --Instructions Tooltip
end
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("10mmsmgshoot") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 7 -- Damage, in standard damage points.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_10mmsmg.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_10mmsmg.mdl" -- Weapon world model path
...
-- pos = Vector(6.51, 1.128, -1.704), angle = Angle(-14.91, -10.04, -172.48)

--Vector(7.013, 1.342, -1.262), angle = Angle(-9.671, -6.782, -177.747)
...
SWEP.IronSightsPos = Vector(-4.16, -3.666, 1.44)
SWEP.IronSightsAng = Vector(0.282, -2.254, 0)
