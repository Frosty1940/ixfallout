...
SWEP.Instructions				= L("itemCombatShotgunDesc") --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= L("Combat shotgun")		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("combatshotgunshoot") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 6.1 -- Damage, in standard damage points.
SWEP.Primary.DamageTypeHandled = true --true will handle damagetype in base
SWEP.Primary.DamageType = nil --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
SWEP.Primary.Force = nil --Force value, leave nil to autocalc
SWEP.Primary.Knockback = nil --Autodetected if nil; this is the velocity kickback
SWEP.Primary.HullSize = 0 --Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
SWEP.Primary.NumShots = 9 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
--Firing Cone Related
SWEP.Primary.Spread = .3 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .3 -- Ironsight accuracy, should be the same for shotguns
...
--Range Related
SWEP.Primary.Range = 200 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_combatshotgun.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_combatshotgun.mdl" -- Weapon world model path
...
--Vector(5.682, 0.666, -1.787), angle = Angle(-13.988, -1.576, 180) combatshotgun
--Vector(4.796, 0.964, -0.82), angle = Angle(-5.844, 0, 180)ak
...
SWEP.IronSightsPos = Vector(-4.881, -5.271, 1.799)
SWEP.IronSightsAng = Vector(-0.459, -2.1, -0.879)
