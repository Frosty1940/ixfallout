if (CLIENT) then
	SWEP.PrintName = L("Caravan shotgun") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("itemCaravanShotgunDesc") --Instructions Tooltip
end

SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "Fallout RP" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer = "Illusion" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("cvshoot") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 6.4 -- Damage, in standard damage points.
SWEP.Primary.DamageTypeHandled = true --true will handle damagetype in base
SWEP.Primary.DamageType = nil --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
SWEP.Primary.Force = nil --Force value, leave nil to autocalc
SWEP.Primary.Knockback = nil --Autodetected if nil; this is the velocity kickback
SWEP.Primary.HullSize = 0 --Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
SWEP.Primary.NumShots = 20 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
--Miscelaneous Sounds
--SWEP.IronInSound = Sound("aimin") --Sound to play when ironsighting in?  nil for default
--SWEP.IronOutSound = Sound("aimout") --Sound to play when ironsighting out?  nil for default
--Silencing
...
SWEP.DefaultFireMode = "Single Fire" --Default to auto or whatev
...
--Recoil Related
SWEP.Primary.KickUp = 4.2 -- This is the maximum upwards recoil (rise)
...
--Firing Cone Related
SWEP.Primary.Spread = .22 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .22 -- Ironsight accuracy, should be the same for shotguns
...
--Range Related
SWEP.Primary.Range = 100 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 0.1 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_caravanshotgun.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_caravanshotgun.mdl" -- Weapon world model path
...
--Vector(7.578, 0.391, -2.803), angle = Angle(-3.027, -2.487, 180) Caravan shotgun
...
SWEP.IronSightsPos = Vector(-4.52, 0, 1.96)
SWEP.IronSightsAng = Vector(-0.281, -1.984, 0.777)

--[[INSPECTION]]--
SWEP.InspectPos = Vector(9.68, 0, -4.24)
SWEP.InspectAng = Vector(9.1, 29.5, -4.2)
...
-- SWEP.StatusLengthOverride = {
	...
	-- ["foregrip_reload"] = 57 / 30,
	-- ["foregrip_reload_empty"] = 66 / 30,
	-- ["gl_reload"] = 57 / 30,
	-- ["gl_reload_empty"] = 66 / 30,
