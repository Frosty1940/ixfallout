...
SWEP.Category				= "Fallout Weapons Project" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("snipershoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi = 60 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.DefaultFireMode = "Bolt-Action" --Default to auto or whatev
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_sniperrifle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_sniperrifle.mdl" -- Weapon world model path
...
--Vector(6.527, 1.381, -1.849), angle = Angle(-15.334, 4.77, 180) dks
...
SWEP.IronSightsPos = Vector(-4.22, -6.961, 1.09)
SWEP.IronSightsAng = Vector(0, -0.35, 0)
local scope = {}
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "sniperrifle", rel = "", pos = Vector(3.19, 2.362, 0.248), angle = Angle(0, -90, -90), size = Vector(0.377, 0.377, 0.377), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
