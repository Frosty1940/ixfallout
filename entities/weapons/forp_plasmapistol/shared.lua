if (CLIENT) then
	SWEP.PrintName = L("Plasma pistol") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("itemPlasmaPistolDesc") --Instructions Tooltip
end
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_plasmapistol.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_plasmapistol.mdl" -- Weapon world model path
...
--Vector(7.684, 1.427, -2.126), angle = Angle(0, 0, 180)
...
SWEP.IronSightsPos = Vector(-5, 0, -0.96)
SWEP.IronSightsAng = Vector(0.62, -2.289, 0)
