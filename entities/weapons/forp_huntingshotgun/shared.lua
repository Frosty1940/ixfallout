...
SWEP.Instructions				= L("itemHuntingShotgunDesc") --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= L("Hunting shotgun")		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("hsshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 24 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.Ammo = "12Gauge" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_huntingshotgun.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_huntingshotgun.mdl" -- Weapon world model path
...
-- Vector(7.545, 1.324, -1.579), angle = Angle(-14.374, 1.085, 180) shotty
--Vector(4.796, 0.964, -0.82), angle = Angle(-5.844, 0, 180) reference
...
SWEP.IronSightsPos = Vector(-4.401, -6.441, 1.559)
SWEP.IronSightsAng = Vector(0.4, -2.125, 0)
