if (CLIENT) then
	SWEP.PrintName = L("Type 93 Chinese assault rifle") -- Weapon name (Shown on HUD)
	SWEP.Instructions = L("itemChineseAssaultRifleDesc") --Instructions Tooltip
end
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("chinesearshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 465 -- This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_chineseassaultrifle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_chineseassaultrifle.mdl" -- Weapon world model path
...
--Vector(7.592, 0.657, -1.737), angle = Angle(-12.054, 0.708, 180)chinesear
--Vector(-10.459, 6.342, -4.795), angle = Angle(-8.683, 3.628, -180) ref
...
SWEP.IronSightsPos = Vector(-4.801, -6.481, 0.959)
SWEP.IronSightsAng = Vector(-0.101, -2.3, 0)
