LANGUAGE = {
	...
	itemPipBoyDesc = "The RobCo Pip-Boy is the ultimate in personal computing devices.",
	...
	itemBuffoutEffectsEnded = "The effects of Buffout have disappeared.",
	itemDayTripperEffectsEnded = "The effects of Day Tripper have disappeared.",
	itemMentatsEffectsEnded = "The effects of Mentats have disappeared.",
	...
	itemBuffoutDesc = "A highly advanced steroid that was popularized before the Great War by professional athletes and their clandestine use of the drug.",
	itemDayTripperDesc = "A pre-war chem favored by those looking for a 'happy escape,' Daytripper raises both Charisma and Luck, but lowers Strength, for a limited period of time.",
	itemMentatsDesc = "A pillbox of mind-altering chems. Increases memory related functions, and speeds other mental processes. Highly addictive",
	itemJanglesDesc = "A large doll of Jangles the Moon Monkey, which was a character in the pre-War TV show The Adventures of Captain Cosmos.",
